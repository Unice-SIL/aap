...
class ProjectFormLayoutFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
         ...
         */
         ...
         $projectFormLayout->setName(self::FORM_LAYOUT_1)->setTitle('Titre');
         ...
         */
        $projectFormLayout = new ProjectFormLayout();
        $projectFormLayout->setName(self::FORM_LAYOUT_2)->setTitle('Titre');
         ...
         */
        $projectFormLayout = new ProjectFormLayout();
        $projectFormLayout->setName(self::FORM_LAYOUT_3)->setTitle('Titre');
