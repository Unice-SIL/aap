...
class MailTemplate
{
    ...
    const PLACEHOLDER_CALL_OF_PROJECT_START_DATE = '[__CALL_OF_PROJECT_START_DATE__]';
    const PLACEHOLDER_CALL_OF_PROJECT_END_DATE = '[__CALL_OF_PROJECT_END_DATE__]';
    ...
    const PLACEHOLDERS = [
        self::NOTIFICATION_USER_NEW_PROJECT => [
            ...
            'app.mail_template.placeholder.call_of_start_date' => self::PLACEHOLDER_CALL_OF_PROJECT_NAME,
            'app.mail_template.placeholder.call_of_project_end_date' => self::PLACEHOLDER_CALL_OF_PROJECT_START_DATE,
            'app.mail_template.placeholder.call_of_project_name' => self::PLACEHOLDER_CALL_OF_PROJECT_END_DATE
        ],
        self::NOTIFICATION_COP_FOLLOWERS_NEW_PROJECT => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_USER_VALIDATION_PROJECT => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_USER_REFUSAL_PROJECT => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_USER_NEW_REPORTER => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_USER_NEW_REPORTERS => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_REPORTER_REPORT_UPDATED => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_COP_FOLLOWERS_REPORT_UPDATED => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
            'app.mail_template.placeholder.project_name' => self::PLACEHOLDER_PROJECT_NAME,
            'app.mail_template.placeholder.project_creator_lastname' => self::PLACEHOLDER_PROJECT_CREATOR_LASTNAME,
        ...
        self::NOTIFICATION_USER_INVITATION => [
            'app.mail_template.placeholder.recipient_lastname' => self::PLACEHOLDER_LASTNAME,
            'app.mail_template.placeholder.recipient_firstname' => self::PLACEHOLDER_FIRSTNAME,
