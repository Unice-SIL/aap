 ...
 */
final class Version20200529093142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `group` (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `group` ADD CONSTRAINT FK_6DC044C5BF396750 FOREIGN KEY (id) REFERENCES common (id) ON DELETE CASCADE');
