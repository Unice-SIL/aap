 ...
 */
final class Version20200414140444 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project_content CHANGE number_value number_value DOUBLE PRECISION DEFAULT NULL, CHANGE date_value date_value DATETIME DEFAULT NULL');
    }
