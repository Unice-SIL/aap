 ...
 */
final class Version20200625091653 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dictionary_content (id INT AUTO_INCREMENT NOT NULL, dictionary_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', code VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, INDEX IDX_1FA02208AF5E5B3C (dictionary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
